...
<!-- Bootstrap core CSS -->
<link href="${host}/assets/bootstrap.min.css" rel="stylesheet" />
<!-- Custom styles for this template -->
<link href="${host}/assets/jumbotron-narrow.css" rel="stylesheet">
<link href="https://pay.vnpay.vn/lib/vnpay/vnpay.css" rel="stylesheet" />
<script src="${host}/assets/jquery-1.11.3.min.js"></script>
</head>
		...
		<div class="table-responsive">
			<form action="vnpayajax" id="frmCreateOrder" method="post">
				...
				<button type="button"
					...
					class="btn btn-default">Trở lại giỏ hàng</button>
			</form>
		</div>
		<p>&nbsp;</p>
		<footer class="footer">
