...
public class Config {
	...
	public static String vnp_Returnurl = "https://localhost:443/vnpay-return";
	public static String vnp_TmnCode = "KJVMSYDO";
	public static String vnp_HashSecret = "TYHARKWHDYHRNAHLNZQTOBCYYQRDICGI";
